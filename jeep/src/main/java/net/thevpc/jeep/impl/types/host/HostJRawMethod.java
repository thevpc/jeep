...
//
//    public HostJRawMethod(Method declaredMethod, JType declaringType) {
//        this.method = declaredMethod;
//        this.declaringType = declaringType;
//        if(!declaringType.isRawType()){
//            throw new IllegalStateException("Error");
//        }
//        JeepPlatformUtils.setAccessibleWorkaround(declaredMethod);
...
//            }
//        }
//        JType[] jeepParameterTypes = ((JTypesSPI)getTypes()).forHostType(declaredMethod.getGenericParameterTypes(),this);
...
//            }
//        }
//        genericReturnType=((JTypesSPI)getTypes()).forHostType(declaredMethod.getGenericReturnType(),this);
//        rawReturnType=((JTypesSPI)getTypes()).forHostType(declaredMethod.getReturnType(),this);
//        typeParameters=Arrays.stream(((JTypesSPI)getTypes()).forHostType(declaredMethod.getTypeParameters(),this)).toArray(JTypeVariable[]::new);
//        if(genericSig!=null){
...
//                }
//            }
//            rawSig=JSignature.of(declaredMethod.getName(), JTypeUtils.buildRawType(genericSig.argTypes(),this),declaredMethod.isVarArgs());
//        }else {
//            genericSig = new JSignature(declaredMethod.getName(), jeepParameterTypes, declaredMethod.isVarArgs());
//            rawSig=JSignature.of(declaredMethod.getName(),JTypeUtils.buildRawType(genericSig.argTypes(),this),declaredMethod.isVarArgs());//just for test
////            rawSig=new JSignature(method.getName(), declaringType.types().forName(method.getParameterTypes()), method.isVarArgs());
//        }
//        this.defaultValue=declaredMethod.getDefaultValue();
//        applyAnnotations(declaredMethod.getAnnotations());
//        applyModifiers(declaredMethod.getModifiers());
//    }
//
