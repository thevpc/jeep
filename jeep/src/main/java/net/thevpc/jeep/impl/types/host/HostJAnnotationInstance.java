...
//
//    public HostJAnnotationInstance(Map<String, Object> properties, JType annotationType) {
//        this.properties = properties;
//        this.annotationType = annotationType;
//        hostType = (Class)((DefaultJType) annotationType).getHostType();
...
//        if(annotation instanceof JType) {
//            this.annotationType = (JType) annotationType;
//        }else if(annotationType.getInterfaces().length==1 && annotationType.getInterfaces()[0] instanceof JType){
//            this.annotationType = (JType) annotationType.getInterfaces()[0];
//        }else{
